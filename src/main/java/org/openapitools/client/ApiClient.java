...
public class ApiClient {
    ...
    protected String basePath = "https://fakestoreapi.com";
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/v2.1.11/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://fakestoreapi.com)
